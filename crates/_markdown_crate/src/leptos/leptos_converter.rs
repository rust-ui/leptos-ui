        ...
        "pre" => {
            ...
            View::new(view! {
                <pre
                    ...
                    class="overflow-x-auto overflow-y-auto overscroll-y-auto overscroll-x-contain py-3.5 px-4 my-2 min-w-0 text-xs rounded-md outline-none no-scrollbar bg-muted"
                >
                    {children}
                </pre>
            }.into_any())
